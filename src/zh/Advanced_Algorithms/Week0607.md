...
# This method calculates the max path based on the greedy choice
def greedy_max_sum(root):
    ...
    while currentNode.left != None or currentNode.right != None:  # check nodes until we reach the bottom of the tree
        if currentNode.left != None and currentNode.right != None:
            if currentNode.left.data > currentNode.right.data:  # check if left data is greater than right data
                solution.append(currentNode.left.data)  # append left data to the solution
                totalSum = totalSum + currentNode.left.data  # add left data to totalSum
                currentNode = currentNode.left
            else:
                solution.append(
                    currentNode.right.data)  # otherwise append right data to the solution and add it to totalSum
                totalSum = totalSum + currentNode.right.data
                currentNode = currentNode.right
        elif currentNode.left != None:  # if left is not None and right is None
            solution.append(currentNode.left.data)  # append left data to solution
            totalSum = totalSum + currentNode.left.data  # add left data to totalSum
            currentNode = currentNode.left
        else:
            solution.append(currentNode.right.data)  # otherwise append right data to solution and add it to totalSum
            totalSum = totalSum + currentNode.right.data
            currentNode = currentNode.right
