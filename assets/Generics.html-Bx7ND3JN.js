import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as i,c as n,e as s}from"./app-Dyg36MV5.js";const a="/assets/image-20240506142602009-D256WY32.png",l="/assets/image-20240506143745929-BTvH9tgS.png",t="/assets/image-20240506144555151-DqZ3Nwqm.png",r="/assets/image-20240506144848209-4ZxEYlFF.png",d="/assets/image-20240506145305541-DpVroTM6.png",c="/assets/image-20240506161655748-D_pG1748.png",o="/assets/image-20240506163707452-BOpC9xRW.png",u={},v=s('<h2 id="_1-boxing-and-unboxing" tabindex="-1"><a class="header-anchor" href="#_1-boxing-and-unboxing"><span>1. Boxing and Unboxing</span></a></h2><p>Boxing is the process of converting a value type to the type object. Unboxing extracts（提取） the value type from the object</p><figure><img src="'+a+`" alt="image-20240506142602009" tabindex="0" loading="lazy"><figcaption>image-20240506142602009</figcaption></figure><p>Boxing is implicit隐性的; unboxing is explicit显性的</p><h3 id="_1-1-boxing" tabindex="-1"><a class="header-anchor" href="#_1-1-boxing"><span>1.1 Boxing</span></a></h3><div class="language-c# line-numbers-mode" data-ext="c#" data-title="c#"><pre class="language-c#"><code>class Program
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-generics-and-collections" tabindex="-1"><a class="header-anchor" href="#_4-3-generics-and-collections"><span>4.3 Generics and Collections</span></a></h3><p>The most common use of generics is to create collection classes.</p><ul><li>泛型的概念是指定一种通用操作，然后以适合每种操作的方式将其应用于不同的上下文中--例如：--我们知道，创建数组时，程序员必须准确指定它包含多少个元素--如果我们的数组大小为 10000，并试图添加 10001 个客户....-</li><li>我们可以声明一个 &quot;oversized &quot;数组，或者...使用泛型。</li></ul><figure><img src="`+c+`" alt="image-20240506161655748" tabindex="0" loading="lazy"><figcaption>image-20240506161655748</figcaption></figure><p>集合类型为 &quot;int&quot;--添加任何非 &quot;int &quot;类型的内容都会产生错误（例如，添加字符串 s）--不会浪费装箱时间，并保证了类型安全.</p><h4 id="_4-3-1-在数组中的应用" tabindex="-1"><a class="header-anchor" href="#_4-3-1-在数组中的应用"><span>4.3.1 在数组中的应用</span></a></h4><div class="language-c# line-numbers-mode" data-ext="c#" data-title="c#"><pre class="language-c#"><code>class Bank&lt;T&gt;
{
    public T[] client;
