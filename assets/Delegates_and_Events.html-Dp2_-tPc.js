...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-8-异步回调" tabindex="-1"><a class="header-anchor" href="#_2-8-异步回调"><span>2.8 异步回调</span></a></h3><p>将委托作为参数</p><ul><li>由于实例化的委托是一个对象，因此可以将其作为参数传递，或分配给一个属性</li><li>这允许方法接受委托作为参数（并在需要时稍后调用）</li><li>这被称为异步回调： -当&lt;长&gt;进程完成时通知调用者的常用方法</li></ul><figure><img src="`+t+'" alt="image-20240506222655870" tabindex="0" loading="lazy"><figcaption>image-20240506222655870</figcaption></figure><h3 id="_2-9-return-delegates-from-a-method" tabindex="-1"><a class="header-anchor" href="#_2-9-return-delegates-from-a-method"><span>2.9 Return delegates from a method</span></a></h3><p>•the return type of the method is an Operation delegate</p><figure><img src="'+d+`" alt="image-20240506223119885" tabindex="0" loading="lazy"><figcaption>image-20240506223119885</figcaption></figure><h2 id="_3-event" tabindex="-1"><a class="header-anchor" href="#_3-event"><span>3. Event</span></a></h2><ul><li><p>事件使一个类或对象能够在感兴趣的事情发生时通知其他类或对象</p></li><li><p>The class that sends (or raises) the event is called the publisher and the classes that receive (or handle) the event are called subscribers</p></li></ul><p>•事件具有以下属性： •发布者决定何时引发事件；订阅者确定针对事件采取的操作 •一个活动可以有多个订阅者。一个订阅者可以处理多个来自多个发布者的事件 •从不引发没有订阅者的事件 •事件通常用于指示用户操作，如按钮点击或菜单图形用户界面中的选择</p><h3 id="_3-1-以编程方式订阅事件" tabindex="-1"><a class="header-anchor" href="#_3-1-以编程方式订阅事件"><span>3.1 以编程方式订阅事件</span></a></h3><p>•定义一个事件处理程序方法，其签名与活动的代表签名：</p><div class="language-c# line-numbers-mode" data-ext="c#" data-title="c#"><pre class="language-c#"><code> void HandleCustomEvent(object sender, CustomEventArgs a)  { // Do something useful here }
