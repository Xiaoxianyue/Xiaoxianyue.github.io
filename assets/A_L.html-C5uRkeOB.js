import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as i,c as n,b as a}from"./app-Cic-4uJl.js";const l="/assets/image-20240507100114460-DulnvrU_.png",d={},s=a(`<h2 id="_1-匿名方法" tabindex="-1"><a class="header-anchor" href="#_1-匿名方法"><span>1. 匿名方法</span></a></h2><ul><li>匿名方法与委托密切相关。</li><li>匿名方法用于创建委托的副本</li><li>匿名方法不能独立存在</li><li>匿名方法的定义以委托关键字开始：</li></ul><div class="language-c# line-numbers-mode" data-ext="c#" data-title="c#"><pre class="language-c#"><code>MessageHandler handler = delegate(string mes)
{
    Console.WriteLine(mes)
}
handler(&quot;hello Sherry!&quot;)
delegate void MessageHandler(string message)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>匿名方法的另一个例子是将委托所代表的参数作为参数进行转移</p><figure><img src="`+l+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>匿名方法 -如果匿名方法使用参数，这些参数必须与委托的参数相匹配。如果匿名方法不需要参数，则带参数的括号会降低：</p><div class="language-c# line-numbers-mode" data-ext="c#" data-title="c#"><pre class="language-c#"><code> MessageHandler handler = delegate 
 {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-lambda" tabindex="-1"><a class="header-anchor" href="#_2-lambda"><span>2. Lambda</span></a></h2><h3 id="_2-1-lambda-表达式" tabindex="-1"><a class="header-anchor" href="#_2-1-lambda-表达式"><span>2.1 Lambda 表达式</span></a></h3><ul><li>Lambda 表达式代表匿名方法的简化记录</li><li>Lambda 表达式允许创建简洁的简洁方法，这些方法可以返回一些值，并可以作为参数传递给其他方法</li><li>要创建一个 lambda 表达式，你需要在 lambda 运算符 =&gt; 的左侧指定输入参数（如果有的话），并将表达式或语句块放在另一侧：</li></ul><div class="language-c# line-numbers-mode" data-ext="c#" data-title="c#"><pre class="language-c#"><code>(list_parameters) =&gt; expression
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Lambda代表一个委托，所以参数传递是一致的</p><div class="language-c# line-numbers-mode" data-ext="c#" data-title="c#"><pre class="language-c#"><code> int Sum(int[] numbers, IsEqual func) 
 {
     int result = 0;
...
delegate int Operation (int x, int y);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,41),t=[s];function r(c,v){return i(),n("div",null,t)}const o=e(d,[["render",r],["__file","A_L.html.vue"]]),b=JSON.parse(`{"path":"/zh/OOP/A_L.html","title":"Anonymous Methods and Lambda Expressions","lang":"zh-CN","frontmatter":{"title":"Anonymous Methods and Lambda Expressions","icon":"c","date":"2024-05-07T09:35:42.000Z","author":"XiaoXianYue","isOriginal":true,"category":["C#","大二下"],"tag":["C#","大二下"],"sticky":false,"star":false,"article":true,"timeline":true,"image":false,"navbar":true,"sidebarIcon":true,"headerDepth":5,"lastUpdated":true,"editLink":false,"backToTop":true,"toc":true,"description":"1. 匿名方法 匿名方法与委托密切相关。 匿名方法用于创建委托的副本 匿名方法不能独立存在 匿名方法的定义以委托关键字开始： 匿名方法的另一个例子是将委托所代表的参数作为参数进行转移 匿名方法 -如果匿名方法使用参数，这些参数必须与委托的参数相匹配。如果匿名方法不需要参数，则带参数的括号会降低： 与传统方法一样，匿名也可以返回结果： 匿名方法可以访问外...","head":[["meta",{"property":"og:url","content":"https://bougiemoonintaurus/zh/OOP/A_L.html"}],["meta",{"property":"og:site_name","content":"an istj's zone"}],["meta",{"property":"og:title","content":"Anonymous Methods and Lambda Expressions"}],["meta",{"property":"og:description","content":"1. 匿名方法 匿名方法与委托密切相关。 匿名方法用于创建委托的副本 匿名方法不能独立存在 匿名方法的定义以委托关键字开始： 匿名方法的另一个例子是将委托所代表的参数作为参数进行转移 匿名方法 -如果匿名方法使用参数，这些参数必须与委托的参数相匹配。如果匿名方法不需要参数，则带参数的括号会降低： 与传统方法一样，匿名也可以返回结果： 匿名方法可以访问外..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-05-12T16:06:52.000Z"}],["meta",{"property":"article:author","content":"XiaoXianYue"}],["meta",{"property":"article:tag","content":"C#"}],["meta",{"property":"article:tag","content":"大二下"}],["meta",{"property":"article:published_time","content":"2024-05-07T09:35:42.000Z"}],["meta",{"property":"article:modified_time","content":"2024-05-12T16:06:52.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Anonymous Methods and Lambda Expressions\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2024-05-07T09:35:42.000Z\\",\\"dateModified\\":\\"2024-05-12T16:06:52.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"XiaoXianYue\\"}]}"]]},"headers":[{"level":2,"title":"1. 匿名方法","slug":"_1-匿名方法","link":"#_1-匿名方法","children":[]},{"level":2,"title":"2. Lambda","slug":"_2-lambda","link":"#_2-lambda","children":[{"level":3,"title":"2.1 Lambda 表达式","slug":"_2-1-lambda-表达式","link":"#_2-1-lambda-表达式","children":[]},{"level":3,"title":"2.2 参数","slug":"_2-2-参数","link":"#_2-2-参数","children":[{"level":4,"title":"2.2.1 参数类型","slug":"_2-2-1-参数类型","link":"#_2-2-1-参数类型","children":[]},{"level":4,"title":"2.2.2 参数个数和设置默认参数","slug":"_2-2-2-参数个数和设置默认参数","link":"#_2-2-2-参数个数和设置默认参数","children":[]},{"level":4,"title":"2.2.3 Lambda 参数返回","slug":"_2-2-3-lambda-参数返回","link":"#_2-2-3-lambda-参数返回","children":[]}]},{"level":3,"title":"2.3 action adding & removing","slug":"_2-3-action-adding-removing","link":"#_2-3-action-adding-removing","children":[]}]}],"git":{"createdTime":1701251856000,"updatedTime":1715530012000,"contributors":[{"name":"Xiaoxianyue","email":"2310219843@qq.com","commits":6}]},"readingTime":{"minutes":3.54,"words":1062},"filePathRelative":"zh/OOP/A_L.md","localizedDate":"2024年5月7日","excerpt":"<h2>1. 匿名方法</h2>\\n<ul>\\n<li>匿名方法与委托密切相关。</li>\\n<li>匿名方法用于创建委托的副本</li>\\n<li>匿名方法不能独立存在</li>\\n<li>匿名方法的定义以委托关键字开始：</li>\\n</ul>\\n<div class=\\"language-c#\\" data-ext=\\"c#\\" data-title=\\"c#\\"><pre class=\\"language-c#\\"><code>MessageHandler handler = delegate(string mes)\\n{\\n    Console.WriteLine(mes)\\n}\\nhandler(\\"hello Sherry!\\")\\ndelegate void MessageHandler(string message)\\n</code></pre></div>","autoDesc":true}`);export{o as comp,b as data};
