import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as i,c as n,b as a}from"./app-C7oLoMR_.js";const l="/assets/image-20240507100114460-DulnvrU_.png",d={},s=a(`<h2 id="_1-匿名方法" tabindex="-1"><a class="header-anchor" href="#_1-匿名方法"><span>1. 匿名方法</span></a></h2><ul><li>匿名方法与委托密切相关。</li><li>匿名方法用于创建委托的副本</li><li>匿名方法不能独立存在</li><li>匿名方法的定义以委托关键字开始：</li></ul><div class="language-c# line-numbers-mode" data-ext="c#" data-title="c#"><pre class="language-c#"><code>MessageHandler handler = delegate(string mes)
{
